...
def main():
    ...
    paths = [['3_ProcessedSession/TrimedSession_5/Train', '4_Png_multiclass/Train'], ['3_ProcessedSession/TrimedSession_5/Test', '4_Png_multiclass/Test']]
    #paths = [['3_ProcessedSession/TrimedSession/Test', '4_Png/Test']]
    for p in paths:
